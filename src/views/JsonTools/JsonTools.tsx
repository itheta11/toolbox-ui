...
const JsonTools = () => {
  return (
    <div className="h-full">
      ...
      <div className="h-[calc(100vh-100px)] bg-red w-full flex justify-center items-center">
...
const ToolTile = ({ title, link }: { title: string; link: string }) => {
  return (
    <div className="flex justify-center item-center w-[150px] p-4 rounded-lg bg-gray-500 text-white tooltile">
